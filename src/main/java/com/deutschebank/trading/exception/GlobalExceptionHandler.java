...
import static com.deutschebank.trading.constants.ErrorConstants.INVALID_SIGNAL;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	/**
	 * This method handles the {@link ValidationException} and maps the appropriate
	 * error messages
	 * 
	 * @param ex      - thrown {@link ValidationException}
	...
	public final ResponseEntity<ErrorDetails> handleValidationException(ValidationException ex, WebRequest request) {
		...
		ErrorDetails errorDetails = new ErrorDetails(new Date(), INVALID_SIGNAL, details);
